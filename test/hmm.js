// refer to https://en.wikipedia.org/wiki/Viterbi_algorithm#Example
...
(function(root) {
  ...
  HiddenMarkovModel.prototype.forward = function(observedSequence) {
    var alpha = [];
    ...
    return {prob: probability, table: alpha};
  };
